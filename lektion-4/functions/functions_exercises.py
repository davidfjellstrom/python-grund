...
def ex_1_1():
    ...
    return sum_range_num(10,30)

def summa_range_num(min_number, max_number):
    return sum(range(min_number, max_number))

# Skriva happy birthday till ett namn funktion
def happy_birthday(namn):
    print(f'Stort grattis till dig {namn}')
    happy_birthday('Allihopa')
